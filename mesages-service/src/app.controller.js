...
import directMessage from './module/directmessage/message.controller.js'
import i18n from "i18n";
import ticket from './module/tickets/ticket.controller.js'
import { Server } from "socket.io";
import http from "http";
import path from "path";
import { fileURLToPath } from "url";
import setupWebSocket from "./utilts/websocket.js";
...
export const bootstrap = (app, express) => {
    ...
    app.use('/direct-messages', directMessage);
